...
gcloud artifacts repositories \
        create tiktok-repository \
        --repository-format=docker \
        --region=us-central1 \
        --description="Repository for TikTok API images"

gcloud builds submit \
        --tag us-central1-docker.pkg.dev/you-project-id/tiktok-repository/tiktok-api
...
export PROJECT_ID=you-project-id # for sa-tiktok-analytics-business and sa-tiktok-analytics-admin
